...
- Git Bisect : recherche par dichotomie avec git bisect run qui a permis d'isoler le commit fautif 40d9014 (seuil passe en str au lieu de int). Corrige sur main.
